...
public class WhiteList implements Serializable {
	...
	public WhiteList(String fullFone) {
		super();
		this.fullFone = fullFone;
	}

	public WhiteList(String ddd, String fone) {
		super();
		this.ddd = ddd;
		this.fone = fone;
	}

	public WhiteList(String fullFone, String ddd, String fone) {
		super();
		this.fullFone = fullFone;
		this.ddd = ddd;
		this.fone = fone;
